...
void SYS_Init(void)
{
    ...
    SYS->GPE_MFPH = SYS_GPE_MFPH_PE10MFP_I2C0_SMBAL | SYS_GPE_MFPH_PE11MFP_I2C0_SMBSUS;
...
int32_t main(void)
{
    ...
    while(ch != 0x30)
    {
        ...
        */
        printf("\n");
        printf("+-------------------------------------------------------+\n");
        printf("|  M4521 I2C SMBUS Driver Sample Code                    |\n");
        printf("|                                                       |\n");
        ...
        printf("\n");
        printf("I2C0_SDA(PA.2), I2C0_SCL(PA.3), I2C_ALERT(PE.10), I2C_SUSPEND(PE.11)\n");
        printf("I2C1_SDA(PE.8), I2C1_SCL(PE.9), I2C_ALERT(PC. 6), I2C_SUSPEND(PC. 7)\n\n");
