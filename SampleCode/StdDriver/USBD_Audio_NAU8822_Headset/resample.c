...
const SR_T srt[] = {
    ...
    { 4096,  8000, 16000,  8},  // 4
    { 8192,  8000,  8000,  8},  // 5
    { 1365, 16000, 96000, 16},  // 6
    { 2731, 16000, 48000, 16},  // 7
    { 2972, 16000, 44100, 16},  // 8
    { 4096, 16000, 32000, 16},  // 9
    { 8192, 16000, 16000, 16},  // 10
    {16384, 16000,  8000, 16},  // 11
    { 2731, 32000, 96000, 32},  // 12
    { 5461, 32000, 48000, 32},  // 13
    { 5944, 32000, 44100, 32},  // 14
    { 8192, 32000, 32000, 32},  // 15
    {16384, 32000, 16000, 32},  // 16
    {32768, 32000,  8000, 32},  // 17
    { 3763, 44100, 96000, 44},  // 18
    { 7526, 44100, 48000, 44},  // 19
    { 8192, 44100, 44100, 44},  // 20
    {11289, 44100, 32000, 44},  // 21
    {22579, 44100, 16000, 44},  // 22
    {45158, 44100,  8000, 44},  // 23
    { 4096, 48000, 96000, 48},  // 24
    { 8192, 48000, 48000, 48},  // 25
    { 8916, 48000, 44100, 48},  // 26
    {12288, 48000, 32000, 48},  // 27
    {24576, 48000, 16000, 48},  // 28
    {49152, 48000,  8000, 48},  // 29
    { 8192, 96000, 96000, 96},  // 30
    {16384, 96000, 48000, 96},  // 31
    {17833, 96000, 44100, 96},  // 32
    {24576, 96000, 32000, 96},  // 33
    {49152, 96000, 16000, 96},  // 34
    {98304, 96000,  8000, 96}   // 35
};
