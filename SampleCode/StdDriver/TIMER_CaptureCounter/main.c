...
int main(void)
{
    ...
    /* Open Timer1 in toggle-output mode and toggle-output frequency is 500 Hz*/
    TIMER_Open(TIMER1, TIMER_TOGGLE_MODE, 1000);
    ...
    /* Start Timer1, Timer3 and Timer2 counting */
    TIMER_Start(TIMER1);
    TIMER_Start(TIMER3);
    TIMER_Start(TIMER2);
